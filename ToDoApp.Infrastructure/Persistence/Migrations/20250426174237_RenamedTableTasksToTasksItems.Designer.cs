...
namespace ToDoApp.Infrastructure.Migrations
{
    ...
    [Migration("20250426174237_RenamedTableTasksToTasksItems")]
    partial class RenamedTableTasksToTasksItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToDoApp.Infrastructure.Persistence.Entities.CategoryEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ToDoApp.Infrastructure.Persistence.Entities.TaskItemEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ToDoApp.Infrastructure.Persistence.Entities.TaskItemEntity", b =>
                {
                    b.HasOne("ToDoApp.Infrastructure.Persistence.Entities.CategoryEntity", "Category")
                        .WithMany("Tasks")
